...
│       ├── dist/          # 빌드 결과물
│       └── npm/           # 플랫폼별 바이너리 패키지
├── examples/              # 사용 예제 코드 (node, web, react-native, cli)
...
상세: [packages.md](packages.md), [packages-hwpjs.md](packages-hwpjs.md), [viewer-architecture.md](viewer-architecture.md).
