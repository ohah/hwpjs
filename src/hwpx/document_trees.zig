...
pub const Bundle = struct {
    ...
    pub fn inspectNoteText(self: *const Bundle, a: std.mem.Allocator, notes: *const note_bodies.Report, options: note_text.Options) !note_text.Report {
        return note_text.inspect(a, self.sections, notes, options);
    }
