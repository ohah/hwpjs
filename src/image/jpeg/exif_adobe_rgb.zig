...
pub const Image = struct {
    ...
    /// The APP1 TIFF/Exif tree, orientation, colour profile and Adobe flags
    /// are not interpreted as a display-ready image contract.
...
/// can enter this unmanaged grayscale/YCbCr path. No Exif TIFF fields are read.
