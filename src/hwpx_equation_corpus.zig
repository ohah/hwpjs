...
const Inspected = union(enum) {
    rejected_zip,
    encrypted,
    accepted: struct { hash: u256, counts: [8]usize },
};
...
test "HWPX equation corpus per-file independent XML digest survey" {
        ...
        while (try walker.next(std.testing.io)) |entry| {
            ...
            switch (outcome) {
                ...
                .accepted => |row| {
                    ...
                    std.debug.print("EQUATION_FILE {d} {x:0>64} {x:0>64} {d} {d} {d} {d} {d} {d} {d} {d}\n", .{
    ...
    std.debug.print("EQUATION_TOTAL {d} {d} {d} {d} {d} {d} {d} {d} {d} {d} {d}\n", .{
