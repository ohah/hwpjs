...
pub const Stats = struct {
    ...
    pub fn merge(self: *Stats, other: Stats) void {
        inline for (.{ "candidates", "external", "copies", "external_copies", "missing", "prefixed", "raw", "unknown", "failures", "failed_external", "invalid_root", "invalid_fat", "encoded_bytes", "streams", "stream_bytes" }) |field| {
