...
pub const Group = struct {
    ...
    fn merge(self: *Group, other: Group) void {
        inline for (.{ "sites", "non_embedded", "targets", "mismatches", "failures", "png_failures", "wmf_failures", "tiff_failures", "pcx_failures", "encoded_bytes" }) |field| @field(self, field) += @field(other, field);
