...
[EMF+ Ellipse exact conic segment 계층](emf-plus-ellipse-device-segments.md)은 affine basis를 공용 Arc segment 생성기의 0도·360도 입력으로 연결해 네 rational quadratic을 반환합니다. Draw/FillEllipse가 같은 iterator를 재사용하며 flattening·stroke/fill·clip·rasterization은 후속 책임입니다.
