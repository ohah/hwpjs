...
[PNG RGBA 픽셀 조립](png-rgba.md)은 `src/image/png/pixels.zig`의 복원 행과 보존한 팔레트·tRNS를 재사용하며, `rgba_raster.zig`가 출력 버퍼·색 깊이 축소·Adam7 배치를 소유합니다.
