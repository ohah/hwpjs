...
재검증 결과: HWPX 전용 테스트는 Debug·ReleaseFast 각각 42/42, 선택적 corpus 조사는 ReleaseFast 21/21, 전체 기본 테스트는 2064/2064 통과했습니다. 전체 audit는 Debug·ReleaseSafe·ReleaseFast에서 통과했고 뒤의 두 모드는 각각 2103/2103 테스트를 통과했습니다. ReleaseSafe 비교 검증도 통과했습니다.
