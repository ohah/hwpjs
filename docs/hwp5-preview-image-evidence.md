...
[GIF 색인 프레임 코어](gif-indexed.md)의 블록/LZW/인터레이스 구현·실측과 [PrvImage 컨테이너 검사](hwp5-preview-image.md)의 연결·소비·한도 검증은 별도 계약으로 분리했습니다. 일반 텍스트 의미·합성 등 아래 전체 요구사항의 완료와는 구분합니다.
