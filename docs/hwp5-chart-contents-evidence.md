...
나머지 하나는 대문자 CONTENTS이며 24,746바이트, 선두 `d7cdc69a`입니다. SHA-256은 `b672049cbc647c8e5ca847a2b5d5e7691ac7f3bdf9d562d979a441644f25ce4b`입니다. 네 종류의 관측용 Vt 문자열은 모두 없었습니다. 따라서 스트림 이름만으로 모든 Contents를 차트 파서에 전달할 수 없습니다. 후속 [Placeable WMF 헤더 검증](wmf-header.md)은 이 항목을 차트가 아닌 명시적 WMF 배치로 분리하지만 record·렌더링 완료를 뜻하지 않습니다.
