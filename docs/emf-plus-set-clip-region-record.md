...
- 공식 Type `0x4034`, Size 12, DataSize 0과 실제 빈 payload 길이를 독립적으로 위반했습니다.
...
전체 `audit`는 세 모드에서 각각 40/40 단계와 1,837/1,837 테스트(native 1,798, chart 31, WMF 8)를 통과했습니다. HWP/WASM 검사는 각 모드 8,905,827회, import 위반 0이며 CFB 변이 12,000회에서 trap 0입니다. 로그는 `/tmp/hwpjs-emfplus-set-clip-region-{Debug,ReleaseSafe,ReleaseFast}-audit.log`입니다.
