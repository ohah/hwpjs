...
정확한 재현 명령은 [개발·검증 명령](development-commands.md)을 따릅니다. 후속 [대상 이미지 바이트 검사](hwpx-fill-brush-image-payloads.md)는 이 연결 결과의 내장 OPF 항목을 별도로 검사합니다. 채움 우선순위·투명도·배치, 편집·저장·무손실 왕복은 남아 있습니다. 이 연결 검사만으로 HWPX 전체 문서 유효성이나 구현 완성을 주장하지 않습니다.
