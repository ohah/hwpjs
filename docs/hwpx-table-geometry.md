...
2026-09-27 현재 내용 재검증: 고정 버전 공식 필드와 현재 직접 자식·격자 예산 코드를 다시 대조하고, 독립 조사기 자체 반례 및 허용 476개 실파일을 실행했습니다. 544개 section에서 표/행/셀 4,182/23,708/106,998개, 선언 격자 칸·셀 범위 방문 각 187,486개였고 누락·중복·주소 불일치·0 범위·격자 밖·중첩 점유·빈 칸 진단은 0개입니다. 표 격자 집중 테스트는 Debug·ReleaseSafe·ReleaseFast 각 11개가 통과했습니다. 이전 known-inspections 8개 shard는 해당 실행 기준 이후 제품 코드가 바뀌지 않아 재사용하며 이 날짜에 재실행한 것으로 세지 않습니다.
