...
[양식 개체의 관측 접두부](hwp5-form-object.md)는 태그 91 payload의 명시적 원문 뷰·타입 분류를, [양식 컨트롤 조립](hwp5-form-controls.md)은 부모 연결·공통 속성·속성 트리의 조립과 공유 예산을 소유합니다. 기본 문서 검증 연결과 구분합니다.
