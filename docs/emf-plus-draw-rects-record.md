...
현재 로컬 HWP corpus에는 EMF+ signature가 없어 실제 한컴 DrawRects 표본과 렌더링 결과는 관측하지 못했습니다. 구현 범위는 wire 구조, borrowed rectangle iteration, Pen 참조와 stream/framing 연결입니다. transform·clipping·stroke 재생과 저장은 미구현입니다.
