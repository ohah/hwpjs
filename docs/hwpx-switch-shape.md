...
이 구조 보고서는 분기를 선택하지 않습니다. 이진·차트 참조에 한정한 선택적 적용은 [조건부 참조 선택](hwpx-switch-selection.md)을 참조합니다.
