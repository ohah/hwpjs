...
최종 소스의 기본 `zig build test --summary all`은 5/5 단계·2,112/2,112 테스트, HWPX 전용 ReleaseFast는 90/90 테스트를 통과했습니다. Debug·ReleaseSafe·ReleaseFast `zig build audit --summary all`은 각각 40/40 단계·2,151/2,151 테스트 통과했습니다. ReleaseSafe 제품 빌드와 기존 JS 비교 빌드는 5/5·8/8 단계 통과했습니다. 선택 corpus의 차트 조사도 최종 소스에서 단독 재실행해 위 93/93 수치를 재확인했습니다. 전체 HWPX 의미·편집·저장 검증을 통과했다는 뜻은 아닙니다.
