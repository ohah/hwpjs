...
`emf_plus_brush_values.zig`는 [BrushType](https://learn.microsoft.com/en-us/openspecs/windows_protocols/ms-emfplus/6a62c568-0916-4032-ab49-7c9e377a3d70)과 [WrapMode](https://learn.microsoft.com/en-us/openspecs/windows_protocols/ms-emfplus/79d01e4a-6a59-4464-bd8c-2d3fe26df5bc)의 정의된 0~4만 승인합니다. [BrushData flags](https://learn.microsoft.com/en-us/openspecs/windows_protocols/ms-emfplus/1ab04f60-1c58-410f-a29e-d725f5eb9b0f)는 알려진 비트를 해석하면서 bit 5와 상위 예약 비트까지 원문 u32로 왕복 보존합니다. 어떤 flag 조합이 어떤 BrushType에서 의미 있는지는 개별 Brush 파서가 소유합니다.
