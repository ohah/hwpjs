...
다섯 관점의 적대적 검토로 (1) 공식 Type/Size/DataSize와 실제 slice 길이, (2) reserved Flags의 무시와 원시 16비트 보존, (3) dx/dy의 little-endian 순서 및 signed zero·NaN payload 비트 보존, (4) stream routing·count·오류 시 원자적 rollback·실제 EMF framing, (5) wire parsing과 clipping-state translation 책임을 각각 대조했습니다.
