...
fn run(mode: u32, bytes: []const u8, limit: usize) ![]u8 {
    switch (mode) {
        ...
        318 => return @import("chart-text-block-objects-probe.zig").run(a, bytes, limit),
        319 => return @import("chart-text-body-probe.zig").run(a, bytes, limit),
        320 => return @import("chart-value-objects-probe.zig").run(a, bytes, limit),
        321 => return @import("chart-text-format-probe.zig").run(a, bytes, limit),
        322 => return @import("chart-value-block-probe.zig").run(a, bytes, limit),
        323 => return @import("chart-axes-probe.zig").run(a, bytes, limit),
        324 => return @import("chart-nullable-title-probe.zig").run(a, bytes, limit),
        325 => return @import("chart-line-items-probe.zig").run(a, bytes, limit),
        326 => return @import("chart-post-line-probe.zig").run(a, bytes, limit),
        327 => return @import("chart-series-prefix-probe.zig").run(a, bytes, limit),
        328 => return @import("chart-series-label-probe.zig").run(a, bytes, limit),
        329 => return @import("chart-series-suffix-probe.zig").run(a, bytes, limit),
        330 => return @import("chart-series-picture-probe.zig").run(a, bytes, limit),
        331 => return @import("chart-series-collection-probe.zig").run(a, bytes, limit),
        332 => return @import("chart-title-body-probe.zig").run(a, bytes, limit),
        333 => return @import("chart-tail-probe.zig").run(a, bytes, limit),
