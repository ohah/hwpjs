...
export function observeSeriesPrefix(bytes,offset,priorTypes,priorObjects){
 ...
 const objectId=object(),typeId=type('VtSeries',2),rawStart=p,raw66=take(66).toString('hex'),arrayStart=p,arrayId=object(),arrayTypeId=type('VtArray'),firstOffset=p,first=word(),collectionTypeId=type('VtCollection'),secondOffset=p,second=word(),baseTypeId=type('VtObject');
