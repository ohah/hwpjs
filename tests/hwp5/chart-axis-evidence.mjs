import {observeAxisPrefix,observeAxisPrefixNullableTitle} from './chart-axis-prefix-evidence.mjs';
...
export function observeAxis(bytes,offset,priorTypes,priorStrings,priorNumbers=new Map()){
 return read(observeAxisPrefix,bytes,offset,priorTypes,priorStrings,priorNumbers);
}
export function observeAxisNullableTitle(bytes,offset,priorTypes,priorStrings,priorNumbers=new Map()){
 return read(observeAxisPrefixNullableTitle,bytes,offset,priorTypes,priorStrings,priorNumbers);
}
function read(prefix,bytes,offset,priorTypes,priorStrings,priorNumbers){
 ...
 const axis=prefix(bytes,offset,types,strings);
