...
pub const Selection = struct {
    ole: @FieldType(core.hwp5.container_validation.Options, "ole") = null,
    ole_binary_report: bool = false,
    ...
    bmp_images_report: bool = false,
    bmp_rle_report: bool = false,
    bmp_profile_report: bool = false,
