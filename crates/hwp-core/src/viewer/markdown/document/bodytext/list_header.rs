//! ListHeader conversion to Markdown
//! ListHeader를 마크다운으로 변환하는 모듈
//!
//! 스펙 문서 매핑: 표 57 - 본문의 데이터 레코드, LIST_HEADER (HWPTAG_BEGIN + 56)
//! Spec mapping: Table 57 - BodyText data records, LIST_HEADER (HWPTAG_BEGIN + 56)
//!
//! Note: 실제 변환은 convert_paragraph_to_markdown에서 처리되므로
