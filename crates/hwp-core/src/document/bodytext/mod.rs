...
pub mod shape_component_arc;
pub mod shape_component_container;
pub mod shape_component_curve;
pub mod shape_component_ellipse;
pub mod shape_component_line;
pub mod shape_component_ole;
pub mod shape_component_picture;
pub mod shape_component_polygon;
pub mod shape_component_rectangle;
pub mod shape_component_textart;
pub mod shape_component_unknown;
pub mod table;
pub mod video_data;
