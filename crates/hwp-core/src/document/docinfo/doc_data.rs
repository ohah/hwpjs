...
impl DocData {
    ...
    pub fn parse(data: &[u8]) -> Result<Self, String> {
        if data.is_empty() {
            return Err("DocData data is empty".to_string());
        }
...
impl ParameterSet {
    ...
    pub fn parse(data: &[u8]) -> Result<Self, String> {
        if data.len() < 4 {
            return Err("ParameterSet must be at least 4 bytes".to_string());
        }
...
impl ParameterItem {
    ...
    pub fn parse(data: &[u8]) -> Result<(Self, usize), String> {
        if data.len() < 4 {
            return Err("ParameterItem must be at least 4 bytes".to_string());
        }
...
) -> Result<(ParameterItemData, usize), String> {
    match item_type {
        ...
        ParameterItemType::I1 => {
            ...
            if data.len() < 1 {
                return Err("Insufficient data for I1".to_string());
            }
        ...
        ParameterItemType::I2 => {
            ...
            if data.len() < 2 {
                return Err("Insufficient data for I2".to_string());
            }
            Ok((
        ...
        ParameterItemType::I4 => {
            ...
            if data.len() < 4 {
                return Err("Insufficient data for I4".to_string());
            }
            Ok((
        ...
        ParameterItemType::I => {
            ...
            if data.len() < 1 {
                return Err("Insufficient data for I".to_string());
            }
        ...
        ParameterItemType::Ui1 => {
            ...
            if data.len() < 1 {
                return Err("Insufficient data for UI1".to_string());
            }
        ...
        ParameterItemType::Ui2 => {
            ...
            if data.len() < 2 {
                return Err("Insufficient data for UI2".to_string());
            }
            Ok((
        ...
        ParameterItemType::Ui4 => {
            ...
            if data.len() < 4 {
                return Err("Insufficient data for UI4".to_string());
            }
            Ok((
        ...
        ParameterItemType::Ui => {
            ...
            if data.len() < 1 {
                return Err("Insufficient data for UI".to_string());
            }
        ...
        ParameterItemType::Array => {
            ...
            if data.len() < 2 {
                return Err("Insufficient data for Array count".to_string());
            }
        ...
        ParameterItemType::Bindata => {
            ...
            if data.len() < 2 {
                return Err("Insufficient data for Bindata".to_string());
            }
            Ok((
