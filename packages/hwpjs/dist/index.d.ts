 ...
 */
export declare function convertToHtml(data: Buffer, options?: ToHtmlOptions | undefined | null): string
 ...
 */
export declare function convertToMarkdown(data: Buffer, options?: ToMarkdownOptions | undefined | null): string
 ...
 * "hwp", "hwpx", or "unknown"
 */
export declare function detect(data: Buffer): string
 ...
 * HTML string representation of the document
 */
export declare function hwpxToHtml(data: Buffer, options?: ToHtmlOptions | undefined | null): string
 ...
 */
export declare function hwpxToJson(data: Buffer): string
 ...
 * Markdown string representation of the document
 */
export declare function hwpxToMarkdown(data: Buffer, options?: ToMarkdownOptions | undefined | null): string
 ...
 */
export declare function parse(data: Buffer): string
