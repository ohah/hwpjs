...
const __wasmUrl = new URL('./hwpjs.wasm32-wasi.wasm', import.meta.url).href
...
const {
  ...
  wasi: __wasi,
  onCreateWorker() {
    const worker = new Worker(new URL('@ohah/hwpjs-wasm32-wasi/wasi-worker-browser.mjs', import.meta.url), {
      type: 'module',
    })
