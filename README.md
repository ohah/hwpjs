...
표·그리기·수식의 공통 속성은 위치·크기·여백·설명 원문과 미지 꼬리를 읽습니다. 설명 부재와 빈 문자열을 구분합니다. 표 본체·셀·캡션은 소유권·셀 수·병합 범위·영역 좌표·알려진 테두리 참조를 검증합니다. 셀 간 겹침/격자 채움·확장 꼬리·개별 도형과 실제 배치는 아직 별도입니다.
