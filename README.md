...
컨트롤 ID와 리스트 기본 헤더도 읽습니다. 리스트의 명세 6바이트/관측 8바이트 배치는 명시적으로 선택합니다. 같은 부모의 리스트 그룹·문단 수를 검증하며, 셀/캡션 등 개체별 속성 검증은 아직 남아 있습니다.
...
표·그리기·수식의 공통 속성은 위치·크기·여백·설명 원문과 미지 꼬리를 읽습니다. 설명 부재와 빈 문자열을 구분하며, 셀/캡션·개별 도형 속성과 실제 배치는 아직 별도입니다.
